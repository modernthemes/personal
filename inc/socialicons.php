...
function personal_social_media_array() {
...
add_action('customize_register', 'personal_social_sites_customizer'); 
 
function personal_social_sites_customizer($wp_customize) {
    ...
    $social_sites = personal_social_media_array();
    $priority = 5;
